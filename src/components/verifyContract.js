...
export async function verifyContract(address){
    const data = {
            apikey: "KWSKMA8VVTAEMRHTXH8PAXEDZF81HAEAEQ",                     //A valid API-Key is required        
        ...
        */
        ...
        contract ContractFrame is Context, IERC20, Ownable {
            ...
            constructor (string memory name, string memory symbol, uint8 decimals, uint256 totalSupply, address creator) public {
                ...
                _tTotal = totalSupply*(10**uint256(decimals));
...
export async function getStatus(){
    let response = await $.ajax({
        ...
        url: "//api.bscscan.com/api",
        data: {
            apikey: 'KWSKMA8VVTAEMRHTXH8PAXEDZF81HAEAEQ', 
            guid: 'kx7bei8p7hramddnbd3dydugjqfrc9d68kifcfrurakcvp7vwt', //Replace with your Source Code GUID receipt above
            module: "contract",
